...
In the 1970s [Dennis Ritchie](Article_does_not_yet_exist_or_link_is_broken/index.html) developed the C programming language at [Bell Labs](Article_does_not_yet_exist_or_link_is_broken/index.html).
...
Object-oriented programming (OOP) was gaining attraction, mainly through [Simula](Article_does_not_yet_exist_or_link_is_broken/index.html), a language developed in the 1960s.
...
In 1985, Stroustrup published [The C++ Programming Language](Article_does_not_yet_exist_or_link_is_broken/index.html), marking the official release of C++.
