...
- label: Go Up
  href: Blupi/Games/index.html
- label: Blocks
  href: Blupi/Games/Speedy_Blupi_(Windows)/Blocks/index.html
- label: Elements
  href: Blupi/Games/Speedy_Blupi_(Windows)/Elements/index.html
- label: Bugs
  href: Blupi/Games/Speedy_Blupi_(Windows)/Bugs/index.html
- label: Controls
  href: Blupi/Games/Speedy_Blupi_(Windows)/Controls/index.html
- label: Covers
  href: Blupi/Games/Speedy_Blupi_(Windows)/Covers/index.html
- label: SBI and SBII
  href: Blupi/Games/Speedy_Blupi_(Windows)/SBI_and_SBII/index.html
- label: Directory Structure
  href: Blupi/Games/Speedy_Blupi_(Windows)/Directory_Structure/index.html
- label: BLP
  href: Blupi/Games/Speedy_Blupi_(Windows)/BLP/index.html
- label: Images
  href: Blupi/Games/Speedy_Blupi_(Windows)/Images/index.html
- label: CONFIG.DEF
  href: Blupi/Games/Speedy_Blupi_(Windows)/CONFIG.DEF/index.html
- label: Level
  href: Blupi/Games/Speedy_Blupi_(Windows)/Level/index.html
- label: Levels
  href: Blupi/Games/Speedy_Blupi_(Windows)/Levels/index.html
- label: Screens
  href: Blupi/Games/Speedy_Blupi_(Windows)/Screens/index.html
- label: Hacks
  href: Blupi/Games/Speedy_Blupi_(Windows)/Hacks/index.html
- label: Level editor
  href: Blupi/Games/Speedy_Blupi_(Windows)/Level_editor/index.html
- label: Mods
...
<table class="infobox">
<tr>
<th colspan="2"> Speedy Blupi (Windows)</th>
</tr>
<tr>
<th>Author</th>
<td><a href="Blupi/Community/Daniel_Roux/index.html">Daniel Roux</a></td>
</tr>
<tr>
<th>Developer (company)</th>
<td><a href="Blupi/Epsitec/index.html">Epsitec</a> SA.
                </td>
</tr>
<tr>
<th>Publisher (company)</th>
<td> Epsitec SA. - released as Speedy Blupi
                </td>
</tr>
<tr>
<th>Publisher (company)</th>
<td><a href="Article_does_not_yet_exist_or_link_is_broken/index.html">eGames</a>, Inc. - released as
                    Speedy
                    Eggbert
                </td>
</tr>
...
<td><a href="Technologies/Programming_languages/C++/index.html">C++</a>
</td>
</tr>
<tr>
<th>Genre</th>
...
<tr>
<th>Type</th>
<td>Game. Platformer. Side-scrolling. Puzzle.
                    <br/>
...
<td><a href="Blupi/Games/Speedy_Eggbert/index.html">Speedy Eggbert</a></td>
</tr>
<tr>
<th>Release date</th>
<td>I: 13th September 1998 II: 2001</td>
</tr>
<tr>
<th>Released in</th>
...
<tr>
<th>Platform</th>
<td>PC - <a href="Technologies/Platforms/Windows/Windows_95/index.html">Windows 95</a> or later</td>
</tr>
<tr>
<th>Years</th>
<td>10-99</td>
...
- https://github.com/orgs/blupi-games/discussions
- https://tooting.ch/@BlupiGames
- ~~https://twitter.com/BlupiGames/~~(account was deleted on 16th February 2025)
...
- Speedy Blupi I
  - [DirectX](Technologies/Libraries/DirectX/index.html) 3.0 or higher
  - DirectX 3.0 or higher Sound Card
- Speedy Blupi II
  - DirectX 5.0 or higher
  - DirectX 5.0 or higher Sound Card
- [Mouse](Article_does_not_yet_exist_or_link_is_broken/index.html)
- [Joypad](Article_does_not_yet_exist_or_link_is_broken/index.html) (optional)
...
- Directory structure
- XCH
<div style="background: orange;"><p>XCH is custom made binary used for Speedy Blupi/Eggbert demo/1/2 games.</p>
<p><i>Note: ZIP or 7Z compression may works for XCH very well - compression ratio even about 5%.</i></p>
<p>It may be possible to share XCH files as QR codes - investigation is needed.</p></div>
...
Blupi version requires a CD.

- to remove the cd check, change offset 4f6(for SB1) or 506 (for SB2) from 75 to eb

Eggbert version works entirely without a CD.
...
[https://gamedev.stackexchange.com/questions/111314/writing-my-own-gravity](https://gamedev.stackexchange.com/questions/111314/writing-my-own-gravity)
...
- **Lava block:** Lava instantly takes one life.
- **Fan:** blows Blupi in a specific direction (vertically or horizontally)
- Moving blocks that slide between fixed points at varying speeds.
- **Moving belt in one direction:** a special block
- Special disappearing and reappearing blocks
- Breakable crates.
...
- Unmoving mines (upper, lower)
- Moving minions, which activate and start moving when a blupi approaches them
