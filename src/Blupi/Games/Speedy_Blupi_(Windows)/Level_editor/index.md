...
The level editor is a self-explanatory friendly intuitive WYSIWYG [editor](https://en.wikipedia.org/wiki/WYSIWYG), which has nothing to catch you out.
...
- Or if it is not possible in the normal way, you may find another way, like modifying game images in its installation directory. Or you can use an already found exploit or find a not yet found exploit
